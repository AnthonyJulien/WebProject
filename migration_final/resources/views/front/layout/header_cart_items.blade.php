...
<div class="mini-cart-wrapper">
    <div class="mini-cart">
        ...
        <ul class="mini-cart-list">
            ...
            @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                ...
                <li class="clearfix">
                    ...
                    <span class="mini-item-price">{{ Session::get('currency') }}{{ ConvertPrice(Session::get('currency'),$getDiscountAttributePrice['final_price']) }}</span>
        ...
        <div class="mini-shop-total clearfix">
            ...
            <span class="mini-total-price float-right">{{ Session::get('currency') }}{{ ConvertPrice(Session::get('currency'), $total_price )}}</span>
        </div>
