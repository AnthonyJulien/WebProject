                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($getCartItems as $item) {{-- $getCartItems is passed in from cart() method in Front/ProductsController.php --}}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h6 class="order-h6">{{ Session::get('currency') }} {{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}</h6> {{-- price of all products (after discount (if any)) (= price (after discoutn) * no. of products) --}}
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="order-h3">{{ Session::get('currency') }} {{ $total_price }}</h3>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            <span class="shipping_charges">{{ Session::get('currency') }} 0</span>
                                                        </h6>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            ...
                                                            @if (\Illuminate\Support\Facades\Session::has('couponAmount')) {{-- We stored the 'couponAmount' in a Session Variable inside the applyCoupon() method in Front/ProductsController.php --}}
                                                                <span class="couponAmount">{{ Session::get('currency') }} {{ \Illuminate\Support\Facades\Session::get('couponAmount') }}</span>
                                                            @else
