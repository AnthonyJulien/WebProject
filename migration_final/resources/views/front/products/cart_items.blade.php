        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <span class="calc-text">{{ Session::get('currency') }} . {{ ConvertPrice(Session::get('currency'), $total_price )}}</span>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <span class="calc-text couponAmount"> {{-- We create the 'couponAmount' CSS class to use it as a handle for AJAX inside    $('#applyCoupon').submit();    function in front/js/custom.js --}}
                            ...
                            {{ Session::get('currency') }} . {{ ConvertPrice(Session::get('currency'), \Illuminate\Support\Facades\Session::get('couponAmount') )}}
                            @else
                                0
                            @endif
                        </span>
                ...
                <tr>
                    ...
                    <td>
                        <span class="calc-text grand_total">{{ Session::get('currency') }} . {{ ConvertPrice(Session::get('currency'), $total_price - \Illuminate\Support\Facades\Session::get('couponAmount') )}}</span> {{-- We create the 'grand_total' CSS class to use it as a handle for AJAX inside    $('#applyCoupon').submit();    function in front/js/custom.js --}} {{-- We stored the 'couponAmount' a Session Variable inside the applyCoupon() method in Front/ProductsController.php --}}
                    </td>
                </tr>
            </tbody>
        </table>
